...
type Article struct {
	...
	Nice      int       `boil:"nice" json:"nice" toml:"nice" yaml:"nice"`
...
var ArticleWhere = struct {
	...
	ArticleID: whereHelperuint{field: "`articles`.`article_id`"},
	Title:     whereHelperstring{field: "`articles`.`title`"},
	Contents:  whereHelperstring{field: "`articles`.`contents`"},
	Username:  whereHelperstring{field: "`articles`.`username`"},
	Nice:      whereHelperint{field: "`articles`.`nice`"},
...
var (
	articleAllColumns            = []string{"article_id", "title", "contents", "username", "nice", "created_at"}
	articleColumnsWithoutDefault = []string{"title", "contents", "username", "nice", "created_at"}
...
func (o *Article) Comments(mods ...qm.QueryMod) commentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`comments`.`article_id`=?", o.ArticleID),
	)
...
func (o *Article) AddComments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Comment) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.ArticleID, rel.CommentID}
...
func FindArticle(ctx context.Context, exec boil.ContextExecutor, articleID uint, selectCols ...string) (*Article, error) {
	articleObj := &Article{}
...
func ArticleExists(ctx context.Context, exec boil.ContextExecutor, articleID uint) (bool, error) {
	var exists bool
